...
// Algolia Rack
const ALGOLIA_APP_ID_ADJUSTMENT = import.meta.env.VITE_APP_ALGOLIA_APP_ID_ADJUSTMENT;
...
// Algolia Rack
const ALGOLIA_APP_ID_RACK = import.meta.env.VITE_APP_ALGOLIA_APP_ID_RACK;
const ALGOLIA_SEARCH_KEY_RACK = import.meta.env.VITE_APP_ALGOLIA_SEARCH_KEY_RACK;
const ALGOLIA_INDEX_RACK = import.meta.env.VITE_APP_ALGOLIA_INDEX_RACK;
...
const clientRack = algoliasearch(ALGOLIA_APP_ID_RACK, ALGOLIA_SEARCH_KEY_RACK);
...
const adjustmentIndex = clientAdjustment.initIndex(ALGOLIA_INDEX_ADJUSTMENT);
const rackIndex = clientRack.initIndex(ALGOLIA_INDEX_RACK);
