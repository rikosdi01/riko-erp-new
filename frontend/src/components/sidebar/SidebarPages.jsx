...
const SidebarPages = () => {
    ...
    const salesSubItems = filterSubItems([
        { text: "Dashboard", to: "/sales/sales-dashboard", icon: <Activity size={20} />, permission: "melihat-dashboard-penjualan" },
    ...
    const inventorySubItems = filterSubItems([
        { text: "Dashboard", to: "/inventory/inventory-dashboard", icon: <Activity size={20} />, permission: "melihat-data-inventaris" },
