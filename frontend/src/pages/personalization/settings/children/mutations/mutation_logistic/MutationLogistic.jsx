...
import './MutationLogistic.css';
import {
    Search
} from "lucide-react";
import ContentHeader from "../../../../../../components/content_header/ContentHeader";

const MutationLogistic = () => {
    ...
    return (
        <div className="mutation-sales-container">
            <ContentHeader title={"Mutasi Pengiriman"} />
            ...
            <div className="filter-section">
                ...
                <select value={filter} onChange={(e) => setFilter(e.target.value)}>
                    ...
                    <option>Faktur Pesanan</option>
                    <option>Pelacakan Pesanan</option>
                    <option>Kurir</option>
...
export default MutationLogistic;
